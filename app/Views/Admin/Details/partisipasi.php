...
<head>
    ...
    <title>GLN GAREULIS - Admin Partisipasi</title>
...
<main role="main" class="flex-shrink-0">
    <div class="container">
        <h1 class="my-5">Data Partisipasi <span class="badge badge-pill badge-info"><?php echo $nik;?></span></h1>
        ...
        <table id="kotaTable" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
            <?php $i = 1; ?>
            <?php foreach ($partisipasi as $p) : ?>
                <tr>
                    <td><?php echo $i++; ?></td>
                    <td><?php echo $p->partisipasi_token;?></td>
                    <td><?php echo $p->partisipasi_pameran;?></td>
                    <td><?php echo $p->partisipasi_festival;?></td>
                    <td><?php echo $p->partisipasi_kemah;?></td>
                    <td><?php echo $p->partisipasi_tantangan;?></td>
                    <td><?php echo $p->created_at;?></td>
                    <td>
                        <div class="d-flex justify-content-between">
                            <a href="javascript:void(0)" class="badge badge-pill badge-warning" onclick=deletePartisipasi(<?php echo $p->id; ?>)>
...
<footer class="footer mt-auto py-3">
    ...
    <script type="text/javascript">
        ...
        var api_uris = "<?php echo route_to('api-admin-delete-partisipasi'); ?>";
        ...
        function deletePartisipasi(id)
        {
            ...
            (question) ? executePartisipasi(id) : false;
        }

        function executePartisipasi(id){
