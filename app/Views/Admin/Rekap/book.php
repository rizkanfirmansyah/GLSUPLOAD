...
<head>
    ...
    <title>GLN GAREULIS - Admin Rekap Buku (baca)</title>
...
<main role="main" class="flex-shrink-0">
    <div class="container">
        <h1 class="my-5">Rekap Data Buku (baca)</h1>
        <a href="<?php echo route_to('rekap-review');?>" class="btn btn-info text-decoration-none mb-2">Review Buku</a>
...
<script type="text/javascript">
    ...
    const api_uri = "<?php echo route_to('datatable-book'); ?>";
