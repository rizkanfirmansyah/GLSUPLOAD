...
<head>
    ...
    <title>GLN GAREULIS - Admin Rekap Buku (review)</title>
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownRekap">
                        ...
                        <a class="dropdown-item active" href="#">Buku <span class="sr-only">(current)</span></a>
...
<main role="main" class="flex-shrink-0">
    <div class="container">
        <h1 class="my-5">Rekap Data Buku (review)</h1>
        <a href="<?php echo route_to('rekap-book');?>" class="btn btn-outline-secondary text-decoration-none mb-2">Baca Buku</a>
        <table id="rekapBukuTable" class="table table-striped table-bordered" style="width:100%">
            <thead>
                <tr>
                    <th>No</th>
                    <th>NIK Buku</th>
...
<script type="text/javascript">
    ...
    const api_uri = "<?php echo route_to('datatable-review'); ?>";

    $(function(){

        let biodata_table = new $('#rekapBukuTable').DataTable({
            "ordering" : false,
            // "filtering" : false,
            "ajax" : {
                "url" : api_uri,
            ...
            "columns" : [
                ...
                { "data" : 'review_cover' },
                { "data" : 'created_at'},
                { "data" : 'link_book', 'className' : 'hideThis'}
            ],
            dom: 'Bfrtip',
            buttons: [
                'csv', 'excel', 'pdf', 'print'
        ...
        $('.buttons-print').on('click', function(e){
            $('#rekapBukuTable').removeClass('hideThis');
            setTimeout(2000);
            $('#rekapBukuTable').addClass('hideThis');
        });
