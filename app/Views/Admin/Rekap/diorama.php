...
<head>
    ...
    <title>GLN GAREULIS - Admin Rekap Diorama</title>
...
<main role="main" class="flex-shrink-0">
    <div class="container">
        <h1 class="my-5">Rekap Data Diorama</h1>
        <table id="rekapDioramaTable" class="table table-striped table-bordered" style="width:100%">
            <thead>
                <tr>
                    <th>No</th>
                    <th>NIK Diorama</th>
...
<script type="text/javascript">
    ...
    const api_uri = "<?php echo route_to('datatable-diorama'); ?>";

    $(function(){

        let biodata_table = new $('#rekapDioramaTable').DataTable({
            "ordering" : false,
            // "filtering" : false,
            "ajax" : {
                "url" : api_uri,
        ...
        $('.buttons-print').on('click', function(e){
            $('#rekapDioramaTable').removeClass('hideThis');
            setTimeout(2000);
            $('#rekapDioramaTable').addClass('hideThis');
        });
