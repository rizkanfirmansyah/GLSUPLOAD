...
<head>
    ...
    <title>GLN GAREULIS - Admin Rekap Video</title>
...
<main role="main" class="flex-shrink-0">
    <div class="container">
        <h1 class="my-5">Rekap Data Video</h1>
        <table id="rekapVideoTable" class="table table-striped table-bordered" style="width:100%">
            <thead>
                <tr>
                    ...
                    <th>NIK Video</th>
                    <th>Token Video</th>
                    <th>Video Link Kegiatan</th>
                    <th>Video Link Cerita</th>
                    <th>Diunggah</th>
...
<script type="text/javascript">
    ...
    const api_uri = "<?php echo route_to('datatable-video'); ?>";
    ...
    $(function(){
        ...
        let biodata_table = new $('#rekapVideoTable').DataTable({
            ...
            "columns" : [
                ...
                { "data" : 'video_ids' },
                { "data" : 'video_token' },
                { "data" : 'video_link_kegiatan' },
                { "data" : 'video_link_cerita' },
                { "data" : 'created_at'},
                { "data" : 'link_video', 'className' : 'hideThis'}
            ],
            dom: 'Bfrtip',
            buttons: [
                'csv', 'excel', 'pdf', 'print'
