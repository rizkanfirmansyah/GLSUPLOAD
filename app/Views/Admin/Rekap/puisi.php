...
<head>
    ...
    <title>GLN GAREULIS - Admin Rekap Karya Tulis (puisi)</title>
...
<main role="main" class="flex-shrink-0">
    <div class="container">
        <h1 class="my-5">Rekap Data Karya Tulis (puisi)</h1>
        ...
        <table id="rekapPuisiTable" class="table table-striped table-bordered" style="width:100%">
            <thead>
                <tr>
                    <th>No</th>
                    <th>NIK Puisi</th>
...
<script type="text/javascript">
    ...
    const api_uri = "<?php echo route_to('datatable-puisi'); ?>";

    $(function(){

        let biodata_table = new $('#rekapPuisiTable').DataTable({
            "ordering" : false,
            // "filtering" : false,
            "ajax" : {
                "url" : api_uri,
            ...
            "columns" : [
                ...
                { "data" : 'puisi_naskah' },
                { "data" : 'created_at'},
                { "data" : 'link_puisi', 'className' : 'hideThis'}
            ],
            dom: 'Bfrtip',
            buttons: [
                'csv', 'excel', 'pdf', 'print'
        ...
        $('.buttons-print').on('click', function(e){
            $('#rekapPuisiTable').removeClass('hideThis');
            setTimeout(2000);
            $('#rekapPuisiTable').addClass('hideThis');
        });
