...
<head>
    ...
    <title>GLN GAREULIS - Kegiatan Telah Selesai</title>
...
<body class="bg-light">
    ...
    <div class="container p-4">
        ...
        <div class="text-center">
            ...
            <h2 class="text-capitalize py-4">Terimakasih telah berpartisipasi dalam kegiatan literasi</h2>
            <h2 class="text-capitalize py-2">Kegiatan Telah Selesai</h2>
        </div>
